...
class LightThemeColurScheme implements AppColorScheme {
  final MaterialColor _primaryColor =
      MaterialColor(const Color(0xFF2D696B).value, const {
    50: Color.fromRGBO(72, 177, 186, .1),
    100: Color.fromRGBO(72, 177, 186, .2),
    200: Color.fromRGBO(72, 177, 186, .3),
    300: Color.fromRGBO(72, 177, 186, .4),
    400: Color.fromRGBO(72, 177, 186, .5),
    500: Color.fromRGBO(72, 177, 186, .6),
    600: Color.fromRGBO(72, 177, 186, .7),
    700: Color.fromRGBO(72, 177, 186, .8),
    800: Color.fromRGBO(72, 177, 186, .9),
    900: Color.fromRGBO(72, 177, 186, 1),
  });
